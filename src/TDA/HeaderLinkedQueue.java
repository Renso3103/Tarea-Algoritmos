...
public class HeaderLinkedQueue implements Queue {
    private NodeQueque front; //apuntador al anterior/frente de la cola
    private NodeQueque rear; //apuntador al posterior/final de la cola
    ...
    public HeaderLinkedQueue(){
        ...
        front=rear=new NodeQueque(); //apunta a un nodo cabecera
        count=0;
    }
    ...
    public void enQueue(Object element) throws QueueException {
        NodeQueque newNode = new NodeQueque(element);
        rear.next = newNode;
