...
import Domain.MantenimientoEmpleados;
...
public class ControlEmpleados extends javax.swing.JFrame {
    ...
    private void jBCrearEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCrearEmpleadoActionPerformed
        ...
        MantenimientoEmpleados ma = new MantenimientoEmpleados("Empleados.txt");
            String lastnameInsertado = e.getLastname();
            String firstnameInsertado = e.getFirstname();
            String titleInsertado = e.getTitle();
            String birthdayInsertado = e.getBirthday();
            String startcontracInsertado = e.getContractstartDate();
            String endcontractInsertado = e.getContractEndDate();
            String genderInsertado = e.getGender();
            String phoneInsertado = e.getPhone();
            String addressInsertado = e.getAddress();
          
           
            int cantidadRegistros = ma.cuentaRegistroEmpleados();
        
            if("".equals(""+lastnameInsertado) || "".equals(""+firstnameInsertado) || "".equals(""+birthdayInsertado) || 
            "".equals(""+startcontracInsertado) || "".equals(""+endcontractInsertado) || "".equals(""+genderInsertado) || 
            "".equals(""+phoneInsertado) || "".equals(""+addressInsertado)){//por si no insertan nombre apellido ... no se guarda

            }else{           
                Empleado emple = new Empleado(""+cantidadRegistros++, ""+lastnameInsertado, ""+firstnameInsertado, 
                ""+titleInsertado,""+birthdayInsertado,""+startcontracInsertado, ""+endcontractInsertado, 
                ""+genderInsertado, ""+phoneInsertado, ""+addressInsertado);
                ma.insertarEmpleado(emple);  
